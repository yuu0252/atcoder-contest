...
from onlinejudge_workaround_for_conflict.dispatch import problem_from_url, service_from_url, submission_from_url
from onlinejudge_workaround_for_conflict.type import Problem, Service, Submission
