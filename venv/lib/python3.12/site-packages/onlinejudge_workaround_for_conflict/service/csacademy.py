...
class CSAcademyService(onlinejudge_workaround_for_conflict.type.Service):
...
class CSAcademyProblem(onlinejudge_workaround_for_conflict.type.Problem):
...
onlinejudge_workaround_for_conflict.dispatch.services += [CSAcademyService]
onlinejudge_workaround_for_conflict.dispatch.problems += [CSAcademyProblem]
