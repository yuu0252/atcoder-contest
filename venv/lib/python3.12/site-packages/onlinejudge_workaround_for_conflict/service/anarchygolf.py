...
class AnarchyGolfService(onlinejudge_workaround_for_conflict.type.Service):
...
class AnarchyGolfProblem(onlinejudge_workaround_for_conflict.type.Problem):
...
onlinejudge_workaround_for_conflict.dispatch.services += [AnarchyGolfService]
onlinejudge_workaround_for_conflict.dispatch.problems += [AnarchyGolfProblem]
