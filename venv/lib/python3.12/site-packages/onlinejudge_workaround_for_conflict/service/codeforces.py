...
class CodeforcesService(onlinejudge_workaround_for_conflict.type.Service):
...
class CodeforcesContest(onlinejudge_workaround_for_conflict.type.Contest):
    """
...
class CodeforcesProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
    :ivar contest_id: :py:class:`int`
...
onlinejudge_workaround_for_conflict.dispatch.services += [CodeforcesService]
onlinejudge_workaround_for_conflict.dispatch.contests += [CodeforcesContest]
onlinejudge_workaround_for_conflict.dispatch.problems += [CodeforcesProblem]
