...
class TophService(onlinejudge_workaround_for_conflict.type.Service):
...
class TophProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
...
onlinejudge_workaround_for_conflict.dispatch.services += [TophService]
onlinejudge_workaround_for_conflict.dispatch.problems += [TophProblem]
