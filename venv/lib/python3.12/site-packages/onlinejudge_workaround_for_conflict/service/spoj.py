...
class SPOJService(onlinejudge_workaround_for_conflict.type.Service):
...
class SPOJProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
...
onlinejudge_workaround_for_conflict.dispatch.services += [SPOJService]
onlinejudge_workaround_for_conflict.dispatch.problems += [SPOJProblem]
