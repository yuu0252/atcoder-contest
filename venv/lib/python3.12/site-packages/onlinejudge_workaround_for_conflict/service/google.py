...
class GoogleCodeJamService(onlinejudge_workaround_for_conflict.type.Service):
...
class GoogleCodeJamProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
...
onlinejudge_workaround_for_conflict.dispatch.services += [GoogleCodeJamService]
onlinejudge_workaround_for_conflict.dispatch.problems += [GoogleCodeJamProblem]
