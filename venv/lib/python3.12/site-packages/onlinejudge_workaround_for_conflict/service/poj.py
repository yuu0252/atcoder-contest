...
class POJService(onlinejudge_workaround_for_conflict.type.Service):
...
class POJProblem(onlinejudge_workaround_for_conflict.type.Problem):
...
onlinejudge_workaround_for_conflict.dispatch.services += [POJService]
onlinejudge_workaround_for_conflict.dispatch.problems += [POJProblem]
