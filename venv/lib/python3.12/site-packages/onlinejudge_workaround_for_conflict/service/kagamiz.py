...
class KagamizContestSystemService(onlinejudge_workaround_for_conflict.type.Service):
...
class KagamizContestSystemProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
...
onlinejudge_workaround_for_conflict.dispatch.services += [KagamizContestSystemService]
onlinejudge_workaround_for_conflict.dispatch.problems += [KagamizContestSystemProblem]
