...
class FacebookHackerCupService(onlinejudge_workaround_for_conflict.type.Service):
...
class FacebookHackerCupProblem(onlinejudge_workaround_for_conflict.type.Problem):
    """
    ...
    def download_sample_cases(self, *, session: Optional[requests.Session] = None) -> List[TestCase]:
        ...
        try:
            ...
            raise onlinejudge_workaround_for_conflict.type.SampleParseError("The result of Facebook's API is empty. Did you set your User-Agent?") from e
...
onlinejudge_workaround_for_conflict.dispatch.services += [FacebookHackerCupService]
onlinejudge_workaround_for_conflict.dispatch.problems += [FacebookHackerCupProblem]
